        ...
        <div class="col-lg-7" style="padding-bottom:120px">
            <form action="index.php?controller=tintuc&action=add" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtTitleTag" />
                </div>
                <div class="form-group">
                    <label>Meta description:</label>
                    <input type="text" class="form-control" name="txtMetaDescription" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtImageAlt" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label class="radio-inline">
                        <input name="rdoTintuc" value="2" type="radio">Tiến độ xây dựng
                    </label>
                </div>
                <div class="form-group">
                    <label>Nổi bật: </label>
